...
func ConvertToProductionPlantRelationMRP(SDC *dpfm_api_input_reader.SDC) *[]ProductionPlantRelationMRP {
	var productionPlantRelationMRP []ProductionPlantRelationMRP

	for _, productionPlantRelation := range SDC.General.ProductionPlantRelation {
		for _, data := range productionPlantRelation.ProductionPlantRelationMRP {
			productionPlantRelationMRP = append(productionPlantRelationMRP, ProductionPlantRelationMRP{
				SupplyChainRelationshipID:                data.SupplyChainRelationshipID,
				SupplyChainRelationshipProductionPlantID: data.SupplyChainRelationshipProductionPlantID,
				Buyer:                                    data.Buyer,
				Seller:                                   data.Seller,
	...
	return &productionPlantRelationMRP
}
